...
# Description: tcp bbr enhancement -Debian -fool
# Version: 1.2.2
# Author: nanqinlang
...
ver_4.10.2(){
	[[ ! -f /lib/modules/`uname -r`/kernel/net/ipv4/tcp_nanqinlang.ko ]] && echo -e "${Info} loading mod" && cd /lib/modules/`uname -r`/kernel/net/ipv4 && wget -O tcp_nanqinlang.ko "https://dl.tunai.win/soft/tcp_nanqinlang-for-v4.10.2.ko" && insmod tcp_nanqinlang.ko && depmod -a
