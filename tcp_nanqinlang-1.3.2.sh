...
install_image(){
	...
	[[ ! -f kernel-ml-4.12.10-1.el${bit}.elrepo.x86_64.rpm ]] && wget https://dl.tunai.win/kernel-ml-4.12.10-1.el${bit}.elrepo.x86_64.rpm
...
install_devel(){
	...
	[[ ! -f kernel-ml-devel-4.12.10-1.el${bit}.elrepo.x86_64.rpm ]] && wget https://dl.tunai.win/kernel-ml-devel-4.12.10-1.el${bit}.elrepo.x86_64.rpm
...
install_headers(){
	...
	[[ ! -f kernel-ml-headers-4.12.10-1.el${bit}.elrepo.x86_64.rpm ]] && wget https://dl.tunai.win/kernel-ml-headers-4.12.10-1.el${bit}.elrepo.x86_64.rpm
...
compile(){
	wget https://dl.tunai.win/tcp_nanqinlang.c
	wget -O Makefile https://dl.tunai.win/Makefile-CentOS
	make && make install
}
